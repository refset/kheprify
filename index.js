var coffee = require('khepri');
//coffee.compile = coffee
var through = require('through');
var convert = require('convert-source-map');

function isCoffee (file) {
    return (/\.((lit)?kep|kep\.md)$/).test(file);
}
...
function compile(file, data, callback) {
    var compiled = {};
    try {
        compiled.js = coffee.compile(data,null,null,null,function(x){return x},function(e){throw(e)}) //"var x = function (){}" // coffee.compile(data)
          /*, {
            sourceMap: true,
            generatedFile: file,
            inline: true,
